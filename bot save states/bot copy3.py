...
def run_discord_bot():
    ...
    #*************************************
    #REACTION ROLE ON A SPECIFIC MESSAGE
    #*************************************
    ...
    #     #OR I could check if the reaction was sent to a certain message
    #      #desired message = await channel.fetch_message(message_id)
    #      #if reaction.message.id != desiredmessage:
    #       #return
    #
    ...
    #************************
    #REMOVE ROLE/GET LIST OF PEOPLE WHO REACTED TO A SPECIFIC MESSAGE
    #************************
    
    # channel_id = 1200237595217641563  # Replace with channel id
    # message_id = 1201104168178430012  # Note these are ints, not strings

    # #The below is how to list reactions
    # @client.tree.command()
    # async def listreactions(interaction: discord.Integration):
